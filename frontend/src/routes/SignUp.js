	...
	return (
		<Layout>
			<div className="flex flex-row min-h-screen justify-center items-center">
				<div className="flex flex-col content-center place-content-center justify-center max-w-md p-6 rounded-md sm:p-10 bg-neutral-900 text-neutral-100">
					<div className="mb-8 text-center">
						<h1 className="my-3 text-4xl font-bold">Sign up</h1>
						<p className="text-sm text-neutral-400">Sign up and create an account</p>
					</div>
					<form novalidate="" action="" className="space-y-12 ng-untouched ng-pristine ng-valid" data-bitwarden-watching="1">
						...
						<div className="space-y-2">
							...
							<p className="px-6 text-sm text-center text-neutral-400">Already have an account? <a rel="noopener noreferrer" href="/sign_in" className="hover:underline text-violet-400">Sign in</a>.</p>
						</div>
					</form>
				</div>
			</div>
